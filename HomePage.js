...
import bus from '../src/assets/vector-bus-icon.jpg';
import person from '../src/assets/personIcon.svg';
import ticket from '../src/assets/ticketIcon.svg';
            ...
            <Grid item xs={12} md={4}>
              <Card>
                ...
                <Typography variant="h4" fontWeight="600" marginTop="1rem" >
                  <a href='/SearchBus'>Search for Bus</a>
                </Typography>
              </Card>
            </Grid>
            <Grid item xs={12} md={4}>
